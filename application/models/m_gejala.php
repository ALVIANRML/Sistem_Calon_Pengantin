...
class m_gejala extends CI_Model
{
	...
	{
		$this->db->like('LOWER(nama_gejala)', strtolower($keyword), 'both', false);
		$this->db->or_like('LOWER(kelompok_gejala_id)', strtolower($keyword), 'both', false);
		return $this->db->from('gejala')->count_all_results();
	}
