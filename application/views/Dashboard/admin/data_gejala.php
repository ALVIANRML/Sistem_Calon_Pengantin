...
<body>
	...
	<div class="container">
		...
		<div class="container-sidebar-dashboard-admin">
			...
			<!-- menu double -->
			<div class="menu menu-double location-menu" id="md1">
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<g id="material-symbols-light:data-table">
						<path id="Vector" d="M4.00001 8.92304H20V5.38504C20 5.23104 19.936 5.09004 19.808 4.96204C19.68 4.83404 19.539 4.76971 19.385 4.76904H4.615C4.46167 4.76904 4.32067 4.83304 4.19201 4.96104C4.06334 5.08904 3.99934 5.23004 4.00001 5.38404V8.92304ZM4.00001 14.077H20V9.92304H4.00001V14.077ZM4.615 19.231H19.385C19.5383 19.231 19.6793 19.1667 19.808 19.038C19.9367 18.9094 20.0007 18.7684 20 18.615V15.077H4.00001V18.616C4.00001 18.7694 4.06401 18.9104 4.19201 19.039C4.32001 19.1677 4.461 19.2317 4.615 19.231ZM5.77001 7.65404V6.03904H7.38501V7.65404H5.77001ZM5.77001 12.808V11.192H7.38501V12.808H5.77001ZM5.77001 17.962V16.346H7.38501V17.962H5.77001Z" fill="#828282" />
					</g>
					...
					<table>
						...
						<tbody>
							<?php foreach ($id as $gejala) : ?>
								<tr>
									<td><?= ++$angka; ?></td>
									<td><?= $gejala['kelompok_gejala_id'] ?></td>
									<td><?= $gejala['kode'] ?></td>
									<td><?= $gejala['nama_gejala'] ?></td>
									<td>
										<div class="container-2-btn">
											<div class="edit-btn" style="cursor: pointer;" data-id="<?= $gejala['id'] ?>" data-kelompokGejala="<?= $gejala['kelompok_gejala_id'] ?>" data-kode="<?= $gejala['kode']  ?>" data-namaGejala="<?= $gejala['nama_gejala'] ?>" onclick="showPopup2(this)">
												<p>Edit</p>
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
											...
											<div class="hapus-btn" style="cursor: pointer;" data-id="<?= $gejala['id'] ?>" onclick="showPopup1(this)">
												<p>Hapus</p>
												<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
							...
							<div class="popup" id="popup">
								...
								<form id="popupForm" action="<?= base_url('dashboard_admin/add_gejala'); ?>" method="post">
									<div class="edit-pendaftaran-container">
										<label for="kelompok_gejala"><b class="form-label">Kelompok Gejala</b><br></label>
										<div class="input-form">
											<input id="kelompok_gejala" name="kelompok_gejala" class="tambah-data">
										</div>
										<label for="kode_gejala"><b class="form-label">Kode gejala</b><br></label>
										<div class="input-form">
							...
							<div class="popup" id="popup1">
								...
								<form id="popupForm" action="<?= base_url('dashboard_admin/hapus_gejala'); ?>" method="post">
									<input type="hidden" name="gejala_id" id="gejala_id" />
							...
							<div class="popup" id="popup2">
								...
								<h2>Tambah Data gejala</h2>
								<hr style="border-color: #015D67;">
								<form id="popupForm" action="<?= base_url('dashboard_admin/edit_gejala'); ?>" method="post">
									<div class="edit-pendaftaran-container">
										...
										<label for="kelompokGejala"><b class="form-label">Kelompok Gejala</b><br></label>
										<div class="input-form">
											<input type="text" id="kelompokGejala" class="tambah-data" name="kelompokGejala" required>
										</div>
										<label for="kodeGejala"><b class="form-label">Kode Gejala</b><br></label>
										<div class="input-form">
											<input id="kodeGejala" name="kodeGejala" class="tambah-data">

										</div>
										<label for="namaGejala"><b class="form-label">Nama Gejala</b><br></label>
										<div class="input-form">
											<input type="text" id="namaGejala" class="tambah-data" name="namaGejala" required>
										</div>
	...
	<script>
		...
		function showPopup1(buttonElement) {
			...
			document.getElementById('gejala_id').value = gejalaId;
		...
		function showPopup2(buttonElement) {
			const gejalaId = buttonElement.getAttribute('data-id');
			const kelompokGejala = buttonElement.getAttribute('data-kelompokGejala');
			const kodeGejala = buttonElement.getAttribute('data-kode');
			const namaGejala = buttonElement.getAttribute('data-namaGejala');

			console.log('gejala ID:', gejalaId);
			console.log('kodeGejala:', kodeGejala);
			console.log('Kode gejala:', kelompokGejala);
			console.log('namaGejala:', namaGejala);

			// Pastikan ID cocok dengan ID elemen di HTML
			document.getElementById('gejalaId').value = gejalaId;
			document.getElementById('kelompokGejala').value = kelompokGejala;
			document.getElementById('kodeGejala').value = kodeGejala;
			document.getElementById('namaGejala').value = namaGejala;
