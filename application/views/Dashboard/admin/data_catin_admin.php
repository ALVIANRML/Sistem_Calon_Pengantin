							...
							<?php foreach ($user_detail as $datas) : ?>
								...
								<div class="popup" id="popup1-<?= $datas['user_id'] ?>">
									...
									<div class="edit-pendaftaran-container">
										...
										<div class="input-form" style="border: none;">
											<textarea rows="4" cols="50" name="keterangan" class="tambah-data" style="height: 90px; width: 700px;" readonly><?= $datas['keterangan_catin'] ?></textarea>
										</div>
									</div>
								</div>
								...
								<div class="popup" id="popup3-<?= $datas['user_id'] ?>">
									...
									<hr style="border-color: #015D67;">
									<div class="edit-pendaftaran-container">
										<p><b>Nama BNN: <?= !empty($datas['nama_bnn']) ? $datas['nama_bnn'] : '<span style="color: red;">Data tidak tersedia</span>' ?></b></p><br>
										<p><b>Nama Pemeriksa: <?= !empty($datas['nama_pemeriksa_bnn']) ? $datas['nama_pemeriksa_bnn'] : '<span style="color: red;">Data tidak tersedia</span>' ?></b></p><br>
										<p><b>Hasil Test Narkoba: <?= !empty($datas['narkoba_test']) ? $datas['narkoba_test'] : '<span style="color: red;">Data tidak tersedia</span>' ?></b></p><br>
										<p><b>Tingkat Kepercayaan: <?= !empty($datas['kepercayaan_bnn']) ? $datas['kepercayaan_bnn'] . '%' : '<span style="color: red;">Data tidak tersedia</span>' ?></b></p><br>
										...
										<textarea name="keterangan" class="tambah-data" style="height: 90px; width: 700px;" readonly><?= $datas['keterangan_bnn'] ?></textarea>
								...
								<div class="popup" id="popup4-<?= $datas['user_id'] ?>">
									...
									<div class="edit-pendaftaran-container">
										...
										<textarea name="keterangan" class="tambah-data" style="height: 90px; width: 700px;" readonly><?= $datas['keterangan_psikolog'] ?></textarea>
								...
								<div class="popup" id="popup5-<?= $datas['user_id'] ?>">
									...
									<div class="edit-pendaftaran-container">
										...
										<form action="<?= base_url('dashboard_admin/data_verifikasi'); ?>" method="post">
											...
											<select type="text" id="role" class="admin-verifikasi" name="data_verifikasi" style="width:100%; height:50px" required>
								...
								<div class="popup" id="popup6-<?= $datas['user_id'] ?>">
									...
									<h2>Aktifkan Kartu</h2>
									<hr style="border-color: #015D67;">
									<div class="edit-pendaftaran-container">
										<label for="role"><b class="form-label">Status Aktif</b><br></label>
										<form action="<?= base_url('dashboard_admin/aktivasi'); ?>" method="post">
											<input type="text" value="<?= $datas['user_id'] ?>" name="id" required hidden> <br>
											<select type="text" id="role" class="admin-verifikasi" name="aktif" style="width:100%; height:50px" required>
												<option value="2">Aktifkan</option>
											</select>
											<label>Tanggal Awal:</label>
											<input type="date" value="<?= $tanggal ?>" style="border: #343a40;" readonly>
											<label>Tanggal Berakhir:</label>
											<input type="date" value="<?= $tanggal_baru ?>" readonly>
											<br>
											<button type="submit">Submit</button>
										</form>
									</div>
								...
								<div class="popup" id="popup10-<?= $datas['user_id'] ?>">
									...
									<hr style="border-color: #015D67;">
									<div class="edit-pendaftaran-container">
										<label for="role"><b class="form-label">Anda yakin ingin menghapus data?</b><br></label>
