...
<body>
        ...
        <div class="container-content">
            <div class="container-content-data-catin-admin">
                ...
                <div class="baris-filter-tanggal">
                    <div>
                        <form id="dateForm" action="<?= base_url('dashboard_admin/admin_filter_tanggal') ?>" method="post">
                            <div class="form-group">
                                <div class="form-input-tanggal">
                                    <input type="date" id="tanggal" name="tanggal" value="<?= $this->session->userdata('admin_tanggal_filter'); ?>">
    ...
    <script>
        document.getElementById('tanggal').addEventListener('change', function() {
            // Submit the form when the date input value changes
