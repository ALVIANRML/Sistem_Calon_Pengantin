		...
		<div class="container-content">
			<div class="container-content-data-catin-admin">
				...
				<div class="baris-filter-tanggal">
					<div>
						<form action="<?= base_url('dashboard_bnn/bnn_filter_tanggal') ?>" method="post">
							<div class="form-group">
								<div class="form-input-tanggal">
									<input type="date" id="tanggal" name="tanggal" value="<?= $this->session->userdata('bnn_tanggal_filter') ?>" onchange="this.form.submit()">
							...
							<?php foreach ($user_detail as $datas) : ?>
								...
								<div class="popup" id="popup5-<?= $datas['user_id'] ?>">
									...
									<div class="edit-pendaftaran-container">
										...
										<form action="<?= base_url('dashboard_bnn/data_verifikasi'); ?>" method="post">
